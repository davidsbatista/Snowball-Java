...
public class REDSTuple extends TermsVector implements Comparable<REDSTuple>, Serializable {
	...
	public REDSTuple(String left, String middle, String right, String e1, String e2, String t_sentence) {
		super();		
		this.e1 = e1;
		this.e2 = e2;
		this.confidence = 0;
