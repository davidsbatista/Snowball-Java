...
public class ReadXML{
	...
	public static LinkedList<Article> returnWithTags(String xml) {
		...
		try {
			...
			DefaultHandler handler = new DefaultHandler() { 
				...
				public void startElement(String uri, String localName,String qName, Attributes attributes) throws SAXException {					
					if (qName.equals("date")) extractDate = true;		
					if (( qName.equals("title_rembrandted") || qName.equals("subtitle_rembrandted") || qName.equals("newstext_rembrandted"))) extract = true;
				...
				public void endElement(String uri, String localName, String qName) throws SAXException {
					...
					if (qName.equals("date")) extractDate = false;
